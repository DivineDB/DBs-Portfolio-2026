...
const META = {
	...
	live: "https://pos-panel.divyanshbaghel.in",
	language: "TypeScript",
	stars: 1,
};
		...
		return (
			<div
				...
				style={{
					...
					boxShadow:
						"0 12px 32px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.04)",
				}}
			>
						...
						{["All", "Drinks", "Snacks", "Sweets"].map((cat, i) => (
							<div
								...
								style={{
									background:
										i === 0
											? "rgba(166,231,199,0.15)"
											: "rgba(255,255,255,0.03)",
									color: i === 0 ? "#a6e7c7" : "rgba(255,255,255,0.4)",
									border:
										i === 0
											? "1px solid rgba(166,231,199,0.2)"
						...
						{[
							...
							>
								<div className="flex flex-col gap-0.5">
									...
									/>
									<span className="text-[10px] font-gilroyBold text-white/90 truncate">
										{prod.name}
									</span>
									<span className="text-[8px] text-white/40">{prod.stock}</span>
								</div>
								<div className="flex items-center justify-between mt-1">
									<span className="text-[10px] font-gilroyBold text-[#a6e7c7]">
										{prod.price}
									</span>
									<div
										className="w-4 h-4 rounded flex items-center justify-center text-[9px] text-white/80"
			...
			>
				...
				<div className="absolute inset-0 flex flex-col p-3 justify-between">
					<div className="flex flex-col gap-2">
						<span className="text-[9px] font-gilroyBold text-white/40 uppercase tracking-widest">
							Active Cart (3 items)
						</span>
						<div className="flex flex-col gap-1.5 max-h-[110px] overflow-hidden">
							{[
								...
								>
									...
									<span className="font-gilroyBold text-white/90">
										{item.price}
									</span>
								</div>
							))}
		...
		>
			...
			<div className="absolute inset-0 flex flex-col p-4 justify-between">
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-2">
						<div
							...
							style={{ background: "#a6e7c7" }}
						/>
						<span className="text-[10px] text-white/60 font-gilroyBold">
							Terminal Active
						</span>
					</div>
				...
				<div className="flex flex-col items-center gap-1.5 my-auto">
					...
					<span className="text-[10px] text-white/50 font-gilroyBold">
						jsPDF Offline Generator
					</span>
				</div>
...
export default function POSCaseStudy() {
	const [activeShowcaseTab, setActiveShowcaseTab] = useState<
		"grid" | "pastels" | "relief" | "animations"
	>("grid");
		...
		>
			...
			<div className="mx-auto max-w-[860px] px-6 py-16 md:py-24 flex flex-col gap-16">
				...
				>
					...
					>
						A touch-first retail checkout console designed for optimal
						throughput, offline resilience, and muscle memory.
					</p>
				</motion.div>
							...
							>
								...
								{[
									...
									<div key={step.stage} className="flex items-start gap-3">
										...
										<div className="flex flex-col gap-0.5">
											<span
												className="text-xs font-gilroyBold"
					...
					>
						<div className="flex flex-col gap-1">
							...
							<p className="text-sm text-slate-600">
								Direct reference specifications detailing terminal interactive
								configurations, touch target parameters, and optic refresh
								systems.
							</p>
						</div>
						...
						>
							<div className="flex items-center justify-between">
								...
								<span
									className="text-[9px] font-gilroyBold uppercase tracking-widest px-2 py-0.5 rounded"
									style={{
										background: "rgba(166,231,199,0.1)",
										color: "#a6e7c7",
									}}
								>
									Tactile POS
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								...
								<div className="flex flex-col gap-3">
									<span
										className="text-[10px] font-gilroyBold uppercase tracking-wider"
									...
									>
										<motion.div
											...
											animate={{
												...
												boxShadow:
													activeShowcaseTab === "pastels"
														? "0 0 12px rgba(166,231,199,0.5)"
														: "none",
												y: activeShowcaseTab === "animations" ? [0, -3, 0] : 0,
											}}
											transition={{
												y: { repeat: Infinity, duration: 1.5, delay: 0 },
											}}
										>
											<span className="text-[8px] font-gilroyBold uppercase tracking-wider">
												Active
											</span>
											<span className="text-[10px] font-gilroyBold leading-none">
												Brand Mint
											</span>
										</motion.div>
										...
										<motion.div
											...
											animate={{
												...
												boxShadow:
													activeShowcaseTab === "pastels"
														? "0 0 12px rgba(251,196,197,0.5)"
														: "none",
												y: activeShowcaseTab === "animations" ? [0, -3, 0] : 0,
											}}
											transition={{
												y: { repeat: Infinity, duration: 1.5, delay: 0.3 },
											}}
										>
											<span className="text-[8px] font-gilroyBold uppercase tracking-wider">
												Alert
										...
										<motion.div
											...
											animate={{
												...
												boxShadow:
													activeShowcaseTab === "pastels"
														? "0 0 12px rgba(171,203,244,0.5)"
														: "none",
												y: activeShowcaseTab === "animations" ? [0, -3, 0] : 0,
											}}
											transition={{
												y: { repeat: Infinity, duration: 1.5, delay: 0.6 },
											}}
										>
											<span className="text-[8px] font-gilroyBold uppercase tracking-wider">
												Regular
										...
										<motion.div
											...
											animate={{
												...
												boxShadow:
													activeShowcaseTab === "pastels"
														? "0 0 12px rgba(209,196,233,0.5)"
														: "none",
												y: activeShowcaseTab === "animations" ? [0, -3, 0] : 0,
											}}
											transition={{
												y: { repeat: Infinity, duration: 1.5, delay: 0.9 },
											}}
										>
											<span className="text-[8px] font-gilroyBold uppercase tracking-wider">
												Special
								...
								<div className="flex flex-col gap-3">
									...
									>
										<div className="flex flex-col gap-1">
											<span className="text-[8px] font-gilroyBold text-white/30 uppercase tracking-widest">
												Base Canvas
											</span>
											<motion.div
										...
										<div className="flex flex-col gap-1">
											...
											<motion.div
												...
												animate={{
													...
													boxShadow:
														activeShowcaseTab === "relief"
															? "0 0 10px rgba(166,231,199,0.15)"
															: "none",
												}}
											>
									...
									{[
										...
										<button
											...
											style={{
												...
												border:
													activeShowcaseTab === tab.id
														? "1px solid rgba(166, 231, 199, 0.3)"
								...
								<div className="bg-black/25 rounded-xl p-4 border border-white/5">
									<AnimatePresence mode="wait">
										...
										>
											{activeShowcaseTab === "grid" && (
												<>
													<h4 className="text-sm font-gilroyBold text-white">
														Locked-Grid Spatial System
													</h4>
													<p className="text-xs font-satoshi text-white/70 leading-relaxed">
														POS terminals require a highly predictable layout
														that builds cashier muscle memory over repetitive
														operations:
													</p>
													<ul className="text-xs font-satoshi text-white/60 flex flex-col gap-1.5 list-disc list-inside">
														<li>
															...
															Anchors the catalog, checkout cart, and checkout
															math in absolute positions that never shift.
														</li>
														<li>
															<strong className="text-white/85">
																Touch-Safe Targets:
															</strong>{" "}
															Imposes a strict minimum bounding size of{" "}
															<strong className="text-[#a6e7c7]">
																48x48 pixels
															</strong>{" "}
															for all interactive buttons to eliminate
															misaligned finger-taps in high-stress retail
															checkouts.
														</li>
													</ul>
												</>
											...
											{activeShowcaseTab === "pastels" && (
												<>
													<h4 className="text-sm font-gilroyBold text-white">
														Color-Coded Pastels & Landmark Grids
													</h4>
													<p className="text-xs font-satoshi text-white/70 leading-relaxed">
														Replaces harsh, saturated primary colors with a
														system of soft pastels to safeguard operators
														against screen fatigue:
													</p>
													<ul className="text-xs font-satoshi text-white/60 flex flex-col gap-1.5 list-disc list-inside">
														<li>
															<strong className="text-white/85">
															...
															Reserved for selected items and high-priority
														...
														<li>
															...
															Triggers supervisor alerts, low-stock warnings,
														...
														<li>
															...
															Segregates categories (e.g. food, drinks, promos)
															into visually recognizable groups.
														</li>
														<li>
															<strong className="text-white/85">
																Active Ink:
															</strong>{" "}
															Solid, high-contrast dark typography layered on
															pastel tiles to maximize readability under
															variable retail light.
														</li>
													</ul>
												</>
											)}
											{activeShowcaseTab === "relief" && (
												<>
													...
													<p className="text-xs font-satoshi text-white/70 leading-relaxed">
														Styled specifically to support long 8+ hour cashier
														shifts:
													</p>
													<ul className="text-xs font-satoshi text-white/60 flex flex-col gap-1.5 list-disc list-inside">
														<li>
															...
															Minimizes display light emission and reduces
														...
														<li>
															...
															Lighter gray cards that visually segment layout
															functions without clutter.
														</li>
														<li>
															<strong className="text-white/85">
																Charcoal Borders:
															</strong>{" "}
															Ultra-thin borders guiding structured navigation
											...
											{activeShowcaseTab === "animations" && (
												<>
													<h4 className="text-sm font-gilroyBold text-white">
														Snappy Micro-Animations
													</h4>
													<p className="text-xs font-satoshi text-white/70 leading-relaxed">
														Visual feedback speed is optimized to keep pace with
														rapid retail processing rates:
													</p>
													<ul className="text-xs font-satoshi text-white/60 flex flex-col gap-1.5 list-disc list-inside">
														<li>
															<strong className="text-white/85">
															...
															Page changes, category filters, and item updates
															complete within{" "}
															<strong className="text-[#a6e7c7]">
																200ms to 300ms
															</strong>
														...
														<li>
															...
															Hovering and tapping yields instant, simple
															translation motion to confirm actions immediately.
														</li>
													</ul>
												</>
											)}
